...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { deal_id: @coupon.deal_id, followers: @coupon.followers, redeemed: @coupon.redeemed, user_id: @coupon.user_id }
    end
  ...
  test "should update coupon" do
    put :update, id: @coupon, coupon: { deal_id: @coupon.deal_id, followers: @coupon.followers, redeemed: @coupon.redeemed, user_id: @coupon.user_id }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
