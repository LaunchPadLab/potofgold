...
class AdvertisersControllerTest < ActionController::TestCase
  ...
  test "should create advertiser" do
    assert_difference('Advertiser.count') do
      post :create, advertiser: { image_url: @advertiser.image_url, uid: @advertiser.uid, username: @advertiser.username }
    end
  ...
  test "should update advertiser" do
    put :update, id: @advertiser, advertiser: { image_url: @advertiser.image_url, uid: @advertiser.uid, username: @advertiser.username }
    assert_redirected_to advertiser_path(assigns(:advertiser))
  end
